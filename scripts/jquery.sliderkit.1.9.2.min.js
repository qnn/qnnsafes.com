...
this.arePanels&&(this.panelsBag=b("."+this.cssNames.panels,this.domObj),"sliding"==this.options.panelfx&&this._wrapPanels());this.lineScrollDo=this.arePanels?0:1;this.options.mousewheel&&this.domObj.mousewheel(function(c,d){0<d?a.stepBackward():a.stepForward();return!1});this.options.keyboard&&this.domObj.keyup(function(c){37==c.keyCode?a.stepBackward():39==c.keyCode&&a.stepForward()});this.options.panelclick&&this.arePanels&&this.panelsBag.click(function(){a.stepForward();return!1});this.startId=
